...
# 获取当前账户资产
def get_balance(acct_id=ACCOUNT_ID):
    """
    :param acct_id
    :return:
    """
...
# print send_order('0.001', '', 'btcusdt', 'sell-limit', '9310.83')
# print send_order('0.001', '', 'btcusdt', 'buy-limit', '310.83')
# print get_kline('btcusdt', '15min', '1')
# send_order('0.1', '', 'btcusdt', 'buy-market', '0')
# #限价卖

#
# #市价卖
# print send_order('0.001', '', 'btcusdt', 'sell-market', '0')
